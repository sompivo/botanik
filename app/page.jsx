    ...
    <div style={S.root}>
      ...
      <div style={S.wrap} className="fi" key={step}>
        ...
        {step==="start" && (<Cd>
          ...
          <button style={S.sec} onClick={function(){setStep("fallback");}}>Najst podla nazvu</button>
        </Cd>)}
        ...
        {step==="fallback" && (<Cd>
          ...
          <input type="text" placeholder="Hladat... (monstera, kaktus...)" value={search} onChange={function(e){setSearch(e.target.value);}} style={S.inp} />
